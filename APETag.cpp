...
/*OPPO 2011-7-4 zouf Add begin for don't analyze when file can't open */
//    m_spIO->Open((LPCTSTR)pFilename);
    if (m_spIO->Open((LPCTSTR)pFilename) >= 0) {
/*OPPO 2011-7-4 zouf Add end  */
...
/*OPPO 2011-7-4 zouf Add begin for  don't Analyze*/
    } else {
        m_bAnalyzed = TRUE;
        m_nFields = 0;
        m_nTagBytes = 0;
