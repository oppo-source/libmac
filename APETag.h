...
private:
    ...
    /*Oplus 2011-01-10 zhouhy Add begin for retrieve wchar string length*/
    size_t ApeWcslen(const str_utf16* s);
    /*Oplus 2011-01-10 zhouhy Add end*/
...
private:
    ...
    /*Oplus 2011-01-10 zhouhy Add begin for compare wchar string*/
