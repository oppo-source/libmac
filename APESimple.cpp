...
int __stdcall DecompressFile(const str_ansi * pInputFilename, const str_ansi * pOutputFilename, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag)
{
 //   CSmartPtr<str_utf16> spInputFile(CAPECharacterHelper::GetUTF16FromANSI(pInputFilename), TRUE);
//    CSmartPtr<str_utf16> spOutputFile(CAPECharacterHelper::GetUTF16FromANSI(pOutputFilename), TRUE);
    return DecompressFileW(pInputFilename, pOutputFilename ? pOutputFilename : NULL, pPercentageDone, ProgressCallback, pKillFlag);
}
...
*****************************************************************************************/
int __stdcall CompressFileW(const str_utf8 * pInputFilename, const str_utf8 * pOutputFilename, int nCompressionLevel, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag)
{
...
int __stdcall DecompressFileW(const str_utf8 * pInputFilename, const str_utf8 * pOutputFilename, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag)
{
    CAPEProgressCallbackLegacy ProgressCallbackLegacy(pPercentageDone, ProgressCallback, pKillFlag);
    return DecompressFileW2(pInputFilename, pOutputFilename, &ProgressCallbackLegacy);
}

int __stdcall ConvertFileW(const str_utf8 * pInputFilename, const str_utf8 * pOutputFilename, int nCompressionLevel, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag)
{
    CAPEProgressCallbackLegacy ProgressCallbackLegacy(pPercentageDone, ProgressCallback, pKillFlag);
...
Compress file
*****************************************************************************************/
int __stdcall CompressFileW2(const str_utf8 * pInputFilename, const str_utf8 * pOutputFilename, int nCompressionLevel, IAPEProgressCallback * pProgressCallback)
{
...
int DecompressCore(const char * pInputFilename, const char * pOutputFilename, int nOutputMode, int nCompressionLevel, IAPEProgressCallback * pProgressCallback)
{
    ...
    // variable declares
    int nFunctionRetVal = ERROR_SUCCESS;
    CSmartPtr<CStdLibFileIO> spioOutput;
    CSmartPtr<IAPECompress> spAPECompress;
    CSmartPtr<IAPEDecompress> spAPEDecompress;
