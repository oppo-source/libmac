...
CAPEInfo::CAPEInfo(int * pErrorCode, const char * pFilename, CAPETag * pTag)
{
    *pErrorCode = ERROR_SUCCESS;
    ...
    if (pTag == NULL)
    {
        ...
        if ((strcmp(pFilename, "http://") == 0) || (strcmp(pFilename, "m01p://") == 0))
        {
            bAnalyzeNow = FALSE;
        }
...
*****************************************************************************************/
long CAPEInfo::GetInfo(APE_DECOMPRESS_FIELDS Field, long nParam1, int nParam2)
{
    long nRetVal = -1;
    ...
    switch (Field)
    {
        ...
        {
            char * pBuffer = (char *)(uintptr_t) nParam1;
            ...
            if (m_APEFileInfo.nFormatFlags & MAC_FORMAT_FLAG_CREATE_WAV_HEADER)
            {
                ...
                {
                    WAVEFORMATEX wfeFormat; GetInfo(APE_INFO_WAVEFORMATEX, (int)(intptr_t) &wfeFormat, 0);
        ...
        {
            WAVEFORMATEX * pWaveFormatEx = (WAVEFORMATEX *)(uintptr_t) nParam1;
        ...
        case APE_INFO_IO_SOURCE:
            nRetVal = (long)(uintptr_t) m_spIO.GetPtr();
            break;
        ...
        case APE_INFO_TAG:
            nRetVal = (long)(uintptr_t) m_spAPETag.GetPtr();
            break;
        case APE_INTERNAL_INFO:
            nRetVal = (long)(uintptr_t) &m_APEFileInfo;
            break;
    }
